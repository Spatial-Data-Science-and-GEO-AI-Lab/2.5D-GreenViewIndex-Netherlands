...
# Calculate the mean VGVI by BU_NAAM using aggregate
vgvi_by_bu <- aggregate(joined_vgvi[, c("VGVI", "geometry")], by = list(joined_vgvi$BU_NAAM), FUN = mean, na.rm = TRUE)
vgvi_by_bu <- vgvi_by_bu %>% rename(VGVI = x)
