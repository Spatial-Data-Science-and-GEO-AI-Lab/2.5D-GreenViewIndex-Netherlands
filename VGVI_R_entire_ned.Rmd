...
# Split the netherlands into tiles
...
# Pre-process - store tiles to reduce the memory issues 

```{r}

# DTM_tmp <- raster("C:/Users/Ondrej/2.5D-GreenViewIndex-Netherlands/Data collection/tiles_dtm/DTM/DTM_merged.tif")
# DSM_tmp <- raster("C:/Users/Ondrej/2.5D-GreenViewIndex-Netherlands/Data collection/tiles_dtm/DSM/DSM_merged.tif")
# GS_tmp <- raster("Data collection/20200629_gm_Bomenkaart_v2_resampled_trees.tif")
# 
...
# cropped_DTM <- split_and_crop_raster(DEM, tiles, 'C:/Users/Ondrej/Archive/2.5D-GreenViewIndex-Netherlands/Data/DTM_cropped')
# cropped_DSM <- split_and_crop_raster(DSM, tiles, 'C:/Users/Ondrej/Archive/2.5D-GreenViewIndex-Netherlands/Data/DSM_cropped')
# cropped_green <- split_and_crop_raster(GreenSpace, tiles, 'C:/Users/Ondrej/Archive/2.5D-GreenViewIndex-Netherlands/Data/Greeness')
...
sampled_points <- st_read("C:/Users/Ondrej/2.5D-GreenViewIndex-Netherlands/Data collection/street_data/sampled_points_ned.gpkg")
...
cities_vgvi <- do.call(rbind, gvi_results)
cities_vgvi
```
...
gdf_income <- read.csv("Data collection/income_data/83765NED_UntypedDataSet_14052023_211018.csv", sep = ";")

head(gdf_income, 3)

# buurt names to join onto income data
gdf_buurt <- st_read("Data collection/income_data/WijkBuurtkaart_2018_v3/buurt_2018_v3.shp")
